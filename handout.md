...
* Factor 1 > Factor level 1 > Counts file(s): (click "collections" icon) **htseq-count collection for condition 1 from step 4a**
* Factor 1 > Factor level 2 > Specify a factor level **c2**
* Factor 1 > Factor level 2 > Counts file(s): (click "collections" icon) **htseq-count collection for condition 2 from step 4b**
